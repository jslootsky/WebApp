...
public class DbMods {
    ...
    public static StringData delete(DbConn dbc, String userId) {
        ...
        try {
            ...
            //counting number of review deletions prior to deleting the record
            int reviewCount = 0;
            try (PreparedStatement countStmt = dbc.getConn()
            ...
            //store in sd to warn front end
            sd.numReviewsToBeDeleted = reviewCount;
